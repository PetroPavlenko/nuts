...
module.exports = function nuts(opts) {
    ...
    router.get('/update/:platform/:version', function(req, res, next) {
        ...
        .then(function(versions) {
            ...
            var releaseNotes = "";
            if (platform.toLowerCase().indexOf('osx') > -1 && tag < '0.1.3') {
                releaseNotes =  '<div style="font-size: 0.9em"> <br>Hey Guys and Gals,<br><br>We change update code therefore you'
                    + ' need to download new version from member area. <br><br>'
                    + '<a class="white-text" href="#"'
                    + 'onclick=\'require("open")("http://members.explaindio.com/assets/video-gif-mixer/"); require("remote").getCurrentWindow().close(); return false;\'>'
                    + 'CLICK HERE</a>'
                    + ' to download new version<br><br>'
                    + ' <a class="white-text" href="#" '
                    + 'onclick=\'require("open")("https://www.facebook.com/groups/vydeogram/");return false;\'>'
                    + 'Join Now</a><br><br>Have Fun<br>Andrew Darius<br>'
                    + '<div style="height: 500vh;"></div></div>';
                latest.tag = '0.1.3';
            } else {
